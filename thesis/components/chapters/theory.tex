...
\begin{enumerate}
    ...
    \item \textbfit{Cosinus ajustat}: $ s(x_1, x_2) = \frac{(x_1 - \parallel x_1 \parallel) \cdot (x_2 - \parallel x_2 \parallel)}{\parallel x_1 - x_m \parallel \cdot \parallel B - x_m \parallel} $, unde $ x_m $ este vectorul medie al tuturor exemplarelor
